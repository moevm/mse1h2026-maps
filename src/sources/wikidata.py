...
def get_entity_id_by_label(label: str, lang: str = 'en',
                          url:str = 'https://www.wikidata.org/w/api.php',
                          headers = {"User-Agent": "Mse1h2026-maps"}) -> str:
...
def fetch_labels_map(ids: set, lang: str = 'en',
                    url:str = 'https://www.wikidata.org/w/api.php',
                   headers = {"User-Agent": "Mse1h2026-maps"}) -> dict:
